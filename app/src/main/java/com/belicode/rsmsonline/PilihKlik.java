...
public class PilihKlik extends AppCompatActivity implements ListView.OnItemClickListener {
    List<Klinik> pList;
    ListView lv;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        new AlertDialog.Builder(PilihKlik.this)
        ...
        StringRequest request = new StringRequest(uri,
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        KlinikAdapter adapter = new KlinikAdapter(PilihKlik.this, pList);
    ...
    public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
        ...
        if (tvidklinik.getText().equals("")) {
            Toast.makeText(PilihKlik.this, "Id BelumDi Pilih", Toast.LENGTH_LONG).show();
        } else {
            pdModel.pdLogin(PilihKlik.this);
                ...
                public void onResponse(String response2) {
                   ...
                   /* tvnamaklinik.setText(nama);
                    ...
                    new Response.ErrorListener() {
                        @Override
                        public void onErrorResponse(VolleyError error) {
                            Toast.makeText(PilihKlik.this, "Not Connections", Toast.LENGTH_LONG).show();
                            pdModel.hideProgressDialog();

                        }
                    });

            RequestQueue requestQueue2 = Volley.newRequestQueue(PilihKlik.this);
    ...
    public void getProfile() {
        String url = ConfigApp.SERVERAPP + "getIdPasien.php";
    ...
    public void inputantrian() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String s) {
                        Toast.makeText(PilihKlik.this, "Succes registrasions...", Toast.LENGTH_LONG).show();
                        updateNomor();
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(PilihKlik.this);
    ...
    public void updateNomor() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url,
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String s) {
                        Toast.makeText(PilihKlik.this, "Succes ", Toast.LENGTH_LONG).show();
                        Intent intent = new Intent(PilihKlik.this, MainMenuActivity.class);
                ...
                new Response.ErrorListener() {
                    @Override
                    public void onErrorResponse(VolleyError volleyError) {
                        Toast.makeText(PilihKlik.this, "Kode Salah", Toast.LENGTH_LONG).show();
